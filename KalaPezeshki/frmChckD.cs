...
{
    public partial class frmChckD : Form
    {
        public frmChckD()
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Clear();
            cmd.Connection = con;
            cmd.CommandText = "select * from Hesab where ShH=@N";
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "Update CheckD set ids='" + txtCode.Text + "',ShH='" + txtShH.Text + "',NameH='" + txtNameH.Text + "',NameM='" + txtNameM.Text + "',Mablagh='" + txtMablagh.Text + "',Tarikh='" + mskTarikh.Text + "',SarResid='" + mskSarResid.Text + "',Vaziyat='" + cmbVaziyat.Text + "',Tozih='" + txtTozih.Text + "' where ids=" + txtCode.Text;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                cmd.Parameters.Clear();
                cmd.Connection = con;
                cmd.CommandText = "insert into CheckD(Ids,ShH,NameH,NameM,Mablagh,Tarikh,SarResid,Vaziyat,Tozih)values(@a,@b,@c,@d,@e,@f,@g,@h,@i)";
